...
public class DbController {
    ...
    /***************websql**********************/
    @PostMapping("/dbSource/sourceController/addDbSource")
    public R addResource(DbSourceModel model){
        return DbService.addDbSource(model);
    }
    @PostMapping("/dbSource/testUrl")
    public R testUrl(DbSourceModel model){
        return DbService.testUrl(model);
    }
}
