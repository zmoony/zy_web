...
;!function (e) {
    ...
    r.prototype.cache = n, r.prototype.define = function (e, t) {
        ...
        var p = this, f = n.dir = n.dir ? n.dir : o,
        ...
        "string" == typeof r && (o = r);
        var c = (o || e).replace(/\.|\//g, ""), s = u.id = "layuicss-" + c,
            p = 0;
...
layui.define("layer", function (e) {
    "use strict";
    var t = layui.$, i = layui.layer, n = layui.hint(), o = layui.device(),
        a = {
    ...
    p.prototype.config = {
        ...
        var n, a = this, l = a.config, r = a.elemFile[0], u = function () {
            var i = 0, n = 0, o = e || a.files || a.chooseFiles || r.files,
                u = function () {
        ...
        var i = this, e = i.config = t.extend({}, i.config, a.config, e),
            n = e.elem.next();
...
layui.define("layer", function (e) {
                    ...
                    f = u.find("select"), v = function (i, l) {
                        ...
                        if (!u) {
                            var C = function () {
                                ...
                                if (e[0]) {
                                    var t = e.position().top, i = g.height(),
                                        a = e.height();
    ...
    var d = function () {
        var e = null, a = f.config.verify, s = "layui-form-danger", o = {},
            c = t(this), u = c.parents(r), d = u.find("*[lay-verify]"),
            v = c.parents("form")[0], h = c.attr("lay-filter");
        return layui.each(d, function (l, r) {
            var o = t(this), c = o.attr("lay-verify").split("|"),
                u = o.attr("lay-verType"), d = o.val();
...
layui.define("form", function (e) {
    ...
    var i = layui.$, a = layui.form, n = layui.layer, t = "tree", r = {
        ...
        }, c = "layui-hide", d = "layui-disabled", s = "layui-tree-set",
        o = "layui-tree-iconClick", h = "layui-icon-addition",
        u = "layui-icon-subtraction", p = "layui-tree-entry",
        f = "layui-tree-main", y = "layui-tree-txt", v = "layui-tree-pack",
        C = "layui-tree-spread", k = "layui-tree-setLineShort",
    ...
    b.prototype.config = {
        ...
        var n = this, t = n.config, r = e.children("." + p),
            l = r.children("." + f), c = r.find("." + o), k = r.find("." + y),
            m = t.onlyIconControl ? c : l, x = "";
        ...
        var t = this, r = t.config, l = e.children("." + p),
            d = l.children("." + f);
        l.children(".layui-tree-btnGroup").on("click", ".layui-icon", function (l) {
            layui.stope(l);
            var f = i(this).data("type"), b = e.children("." + v),
...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    F.prototype.config = {
        ...
        var l = a.elem, n = l.next("." + v), o = e.elem = t(i(z).render({
            VIEW_CLASS: v,
            data: a,
            index: e.index
        }));
        ...
        var c = this, s = c.config, y = e[s.response.dataName] || [],
            h = e[s.response.totalRowName], v = [], m = [], g = [],
            b = function () {
                var e;
                return !r && c.sortKey ? c.sort(c.sortKey.field, c.sortKey.sort, !0) : (layui.each(y, function (a, l) {
                    ...
                    0 !== l.length && (r || (l[d.config.indexName] = a), c.eachCols(function (n, r) {
                        var c = r.field || n, v = s.index + "-" + r.key,
                            m = l[c];
        ...
        var e, i = this, a = i.config, o = t("body"), c = {},
            s = i.layHeader.find("th"), h = ".layui-table-cell",
                    ...
                    s({
                        list: function () {
                            ...
                            n.on("checkbox(LAY_TABLE_TOOL_COLS)", function (e) {
                                var l = t(e.elem), n = this.checked,
                                    o = l.data("key"), r = l.data("parentkey");
...
layui.define("jquery", function (e) {
    ...
    !function (e, t, i) {
        ...
        function n() {
            a = t[l](function () {
                o.each(function () {
                    var t = e(this), i = t.width(), n = t.height(),
                        a = e.data(this, u);
        ...
        var a, o = e([]), r = e.resize = e.extend(e.resize, {}),
            l = "setTimeout", c = "resize", u = c + "-special-event",
            g = "delay", s = "throttleWindow";
