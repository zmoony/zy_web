!function (e, t) {
    ...
    function a(e, t, n) {
        var s, i = Math.min(e.length, t.length),
            r = Math.abs(e.length - t.length), a = 0;
    ...
    var Z = /\d/, z = /\d\d/, $ = /\d{3}/, q = /\d{4}/, J = /[+-]?\d{6}/,
        B = /\d\d?/, Q = /\d\d\d\d?/, X = /\d\d\d\d\d\d?/, K = /\d{1,3}/,
        ee = /\d{1,4}/, te = /[+-]?\d{1,6}/, ne = /\d+/, se = /[+-]?\d+/,
    ...
    function Ht(e) {
        var t = R(e), n = t.year || 0, s = t.quarter || 0, i = t.month || 0,
            r = t.week || t.isoWeek || 0, a = t.day || 0, o = t.hour || 0,
            u = t.minute || 0, l = t.second || 0, h = t.millisecond || 0;
    ...
    mn.add = Jt, mn.calendar = function (e, t) {
        var n = e || bt(), s = Gt(n, this).startOf("day"),
    ...
    var On = Yn("ms"), Tn = Yn("s"), bn = Yn("m"), xn = Yn("h"), Pn = Yn("d"),
        Wn = Yn("w"), Cn = Yn("M"), Hn = Yn("Q"), Rn = Yn("y");
    ...
    var Fn = Un("milliseconds"), Ln = Un("seconds"), Nn = Un("minutes"),
        Gn = Un("hours"), Vn = Un("days"), En = Un("months"), In = Un("years");
    ...
    function $n() {
        ...
        var e, t, n = Zn(this._milliseconds) / 1e3, s = Zn(this._days),
            i = Zn(this._months);
        t = S((e = S(n / 60)) / 60), n %= 60, e %= 60;
        var r = S(i / 12), a = i %= 12, o = s, u = t, l = e,
            h = n ? n.toFixed(3).replace(/\.?0+$/, "") : "",
            d = this.asSeconds();
        if (!d) return "P0D";
        var c = d < 0 ? "-" : "", f = zn(this._months) !== zn(d) ? "-" : "",
    ...
    return qn.isValid = function () {
        ...
        var e, t, n, s, i, r = this._milliseconds, a = this._days,
            o = this._months, u = this._data;
